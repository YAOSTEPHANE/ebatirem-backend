                    ...
                    <div>
                        <div className="mx-auto mt-12 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                            ...
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <h1 className="text-4xl my-5 font-bold tracking-tight text-gray-900">Commande # {order.id}</h1>
                                <h3 className="text-xl my-5 font-bold tracking-tight text-red-600">Status de la Commande: {order.status}</h3>
                                                ...
                                                <div className="ml-4 flex flex-1 flex-col">
                                                    <div>
                                                        <div className="flex justify-between text-base font-medium text-gray-900">
                                                            ...
                                                            <p className="ml-4">{discountedPrice(item)} FCFA</p>
                                                        </div>
                            ...
                            <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                <div className="flex justify-between my-2 text-base font-medium text-gray-900">
                                    <p>Total</p>
                                    <p>{order.totalAmount} FCFA</p>
                                </div>
                                <div className="flex justify-between my-2 text-base font-medium text-gray-900">
                                    <p>Total des article dans le panier</p>
                                    <p>{order.totalItems} articles</p>
                                </div>
                                <p className="mt-0.5 text-sm text-gray-500">Addresse de Livraison.</p>
                                <div className="flex justify-between gap-x-6 px-5 py-5 border-solid border-2 border-gray-200">
                                    ...
                                    <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                                        <p className="text-sm leading-6 text-gray-900">Telephone: {order.selectedAddress.phone}</p>
