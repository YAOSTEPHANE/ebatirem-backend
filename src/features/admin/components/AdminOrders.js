                        ...
                        <table className="min-w-max w-full table-auto">
                            <thead>
                                <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                                    ...
                                    <th className="py-3 px-6 text-center">Addresse d'Envoie</th>
                                ...
                                {orders.map(order => <tr className="border-b border-gray-200 hover:bg-gray-100">
                                    ...
                                    <td className="py-3 px-6 text-left">
                                        {order.items.map(item => <div className="flex items-center">
                                            ...
                                            <span>{item.product.title} - #{item.quantity} - {discountedPrice(item.product)} FCFA</span>
                                        </div>)}
                                    </td>
                                    ...
                                    <td className="py-3 px-6 text-center">
                                        {order.id === editableOrderId ? (
                                            <select onChange={(e) => handleUpdate(e, order)}>
                                                ...
                                                <option value='dispatched'>Expedié</option>
                                    ...
                                    <td className="py-3 px-6 text-center">
                                        <div className="flex item-center justify-center">
                                            <div className="w-6 mr-2 transform hover:text-purple-500 hover:scale-100">
